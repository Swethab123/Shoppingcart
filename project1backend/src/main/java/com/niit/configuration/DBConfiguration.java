...
//to create beans
	...
	public SessionFactory sessionFactory() {
		...
		Class classes[]=new Class[]{CustomerOrder.class,CartItem.class,Product.class,Category.class,Customer.class,User.class,Authorities.class,BillingAddress.class,ShippingAddress.class,Cart.class,Payment.class};
